...
<html lang="fr">
    <head>
        ...
        <title><?= $sitename.' - Tchat privé With '.$_GET['token']; ?></title>
                        ...
                        <div class="card">
                            <div class="card-header msg_head">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="/images/avatar/<?= $avatar; ?>" alt="<?= $pseudo; ?>" class="rounded-circle user_img">
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                                        <span>Chat with <?= $pseudo; ?></span>
                                        <p>1767 Messages</p>
                                    </div>
                                    <div class="video_cam">
